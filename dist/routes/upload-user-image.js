...
var uploadUserImage = {
  ...
  handler: function () {
    var _handler = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
      var _req$body, user_id, image, authorization, token;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _req$body = req.body, user_id = _req$body.user_id, image = _req$body.image;
                ...
                return _regeneratorRuntime().wrap(function _callee$(_context) {
                  while (1) switch (_context.prev = _context.next) {
                    ...
                    case 7:
                      db = _context.sent;
                      _context.next = 10;
                      return db.query("UPDATE users SET image = '{\"data\": \"".concat(image, "\"}' WHERE user_id = '").concat(user_id, "'"));
                    case 10:
