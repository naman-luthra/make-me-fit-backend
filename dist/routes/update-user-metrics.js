...
var updateUsermetrics = {
  path: '/api/update-user-metrics',
  method: 'post',
  handler: function () {
    var _handler = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
      var _req$body, user_id, weight, height, weightGoal, gender, authorization, token;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _req$body = req.body, user_id = _req$body.user_id, weight = _req$body.weight, height = _req$body.height, weightGoal = _req$body.weightGoal, gender = _req$body.gender;
                ...
                return _regeneratorRuntime().wrap(function _callee$(_context) {
                  while (1) switch (_context.prev = _context.next) {
                    ...
                    case 7:
                      db = _context.sent;
                      _context.next = 10;
                      return db.query("UPDATE users SET weight = ".concat(weight, ", height = ").concat(height, ", weight_goal = ").concat(weightGoal, ", gender = '").concat(gender, "' WHERE user_id = '").concat(user_id, "'"));
                    case 10:
